    ...
    for (let i = 0; i < inputed.length; i++) {
      if (sl) {
        if (inputed.charAt(i) === ' ') {
          ...
          } else if (slovo === 'turn off') {
            zmena = 0;
            slovo = '';
            sl = false;
          } else if (slovo === 'turn on') {
            zmena = 1;
            slovo = '';
            sl = false;
          } else if (slovo === 'through') {
            slovo = '';
            sl = false;
          }
          //console.log(slovo);
        ...
        if (inputed.charAt(i) === ' ') {
          if (cisla.length === 1) {
            cisla.push(Number(cislo));
            //console.log(cislo);
            cislo = '';
            sl = true;
          } else if (cisla.length === 3) {
            cisla.push(Number(cislo));
            cislo = '';
            for (let j = 0; j < svetla.length; j++) {
              if (
                svetla[j].a <= cisla[2] &&
                svetla[j].a >= cisla[0] &&
                svetla[j].b <= cisla[3] &&
